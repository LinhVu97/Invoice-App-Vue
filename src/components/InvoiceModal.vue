        ...
        <form @submit.prevent="submitForm" class="invoice-content">
                ...
                <div class="work-items">
                    ...
                    <table class="item-list">
                        ...
                        <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
                            ...
                            <img style="cursor: pointer" @click="deleteInvoiceItem(item.id)" 
            ...
            <div class="save flex">
                ...
                <div class="right flex">
                    ...
                    <button v-else type="submit" @click="updateInvoice" class="purple">Update Invoice</button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    ...
    methods: {
        ...
        async uploadInvoice() {
            ...
            const data = db.collection('invoices').doc()
            await data.set({
                invoiceId: uid(6),
        ...
        async updateInvoice() {
            ...
            const data = db.collection('invoices').doc(this.docId)
            await data.update({
                billerStreetAddress: this.billerStreetAddress,
                billerCity: this.billerCity,
                billerZipCode: this.billerZipCode,
            ...
            this.UPDATE_INVOICE(dataUpdate)
        },
